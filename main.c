...
main (int argc, char *argv[])
{
  ...
  btnFileOpen = GTK_FILE_CHOOSER_BUTTON (
  ...
  /* Custom styling on the file open to draw attention. */
  GtkStyleContext *context2 = gtk_widget_get_style_context(GTK_WIDGET(btnFileOpen));
  GtkCssProvider *provider2 = gtk_css_provider_new();
  gtk_css_provider_load_from_data(provider2,
                                      "filechooserbutton>button {background-color: #00AAAA;}\n", -1, NULL);
